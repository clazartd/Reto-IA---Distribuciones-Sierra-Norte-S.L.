...
- Implementar test unitarios en frontend Angular: components, services, guards, pipes y helpers, con TestBed/Jest/Karma, cubriendo lógica reactiva, UX y errores.
- **Dashboard**:
